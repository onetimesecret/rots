...
## Status
Superseded by issue #48 (2026-04-20). The `rots cloudinit` subcommand was removed in favor of `lots cloudinit` in the management toolchain, which has typed dataclass models, profile-based generators, and secrets support. The string-template decision documented below is no longer load-bearing for this codebase.
