...
class TestPushCommand:
    """Test push command (now an error stub; remote push is unsupported)."""

    def test_push_raises_system_exit(self, tmp_path, mocker):
        """proxy push should raise SystemExit explaining remote is unsupported."""
        from rots.commands.proxy.app import push

        mocker.patch("rots.commands.proxy.app.Config")
        source = tmp_path / "Caddyfile.template"
        source.touch()
